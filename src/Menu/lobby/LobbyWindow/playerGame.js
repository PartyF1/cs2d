...
//пока ничего не делает, но может понадобится
...
class PlayerGames extends React.Component{
  constructor(props) {
    ...
    //обрабатывает нажатие кнопки создания игры. Он просто вызывает бэкэнд каналов с сообщением о создании новой игры.
